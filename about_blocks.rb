...
class AboutBlocks < Neo::Koan
  ...
  # Gotcha: So it seems that {} is the same as do/end
  ...
  # Gotcha: Both of these pass the 10 into the block
  # Lambda seems to be the way to define a lone block by itself
  ...
  # Gotcha: using lamba and the & operator you can pass a block into a method
  ...
  # Gotcha: You must use a & when passing a block/lambda to a method
