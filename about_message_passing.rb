...
class AboutMessagePassing < Neo::Koan
  ...
  # So sending an message to an instance of a class runs the method??
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # Because if you define a send method in the class, __send__ will be your backup
  end
  ...
  # use respond_to? to see if you get a response
  # the power in messages is the ability to manipulate strings in your program to send to a class
  ...
  def test_sending_a_message_with_arguments
    ...
    # you can run the add_a_payload method or you can send a message prepended with the symbold of the message name
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # muan khan muan khan. Canot send message when method is not defined
  ...
  # So here we're redefining method_missing, wich catches any non-executable methods
  ...
  # so it's saying it is not responding, even though it is. But this is useful because it shows that the message is being caught, not executed by a pre-defined method
  # ------------------------------------------------------------------
  ...
  # I need to spend some more time digesting this part. I get 80% of it, but I'm still missing some pieces.
