...
def score(dice)
  ...
  score = 0                   # Set initial score equal to zero
  pos_digits = (1..6).to_a    # Create array of all possible dice values

  pos_digits.each do |num|    # Iterate through all digits
    if dice.count(num) >= 3
      if num == 1             # If 3 ones, add 1,000 to score
        score += 1000
      else
