...
class AboutClassMethods < Neo::Koan
  ...
  # There are lots of automatically included methods
  ...
  # I can add a method to an instance of a class, and not the entire class
  ...
  # Note: Dog2.wag returns the class level wag that was defined. The instance level wag runs when an instance of the class is created
  ...
  # Could be useful for shortening code. Always having a class return an instance variable or something
  # ------------------------------------------------------------------
  ...
  # I prefer the first one because it's shorter. I'm still trying to figure out the utility of a class level method though vs. an instance level method
